...
const docsSearchIndex = {
  en: [
    ...
    { title: 'Checks', meta: '/docs/#checks', href: '/docs/#checks' },
    { title: 'typo-suspect check', meta: '/docs/#check-typo', href: '/docs/#check-typo' },
    { title: 'direct-url check', meta: '/docs/#check-direct-url', href: '/docs/#check-direct-url' },
    { title: 'recent-release check', meta: '/docs/#check-recent-release', href: '/docs/#check-recent-release' },
    { title: 'empty-description check', meta: '/docs/#check-empty-description', href: '/docs/#check-empty-description' },
    { title: 'suspicious-url check', meta: '/docs/#check-suspicious-url', href: '/docs/#check-suspicious-url' },
    { title: 'repository-mismatch check', meta: '/docs/#check-repository-mismatch', href: '/docs/#check-repository-mismatch' },
    { title: 'email-domain-drift check', meta: '/docs/#check-email-domain-drift', href: '/docs/#check-email-domain-drift' },
    { title: 'zero-version check', meta: '/docs/#check-zero-version', href: '/docs/#check-zero-version' },
    { title: 'suspicious-pth check', meta: '/docs/#check-suspicious-pth', href: '/docs/#check-suspicious-pth' },
  ...
  zh: [
    ...
    { title: '检查项', meta: '/zh-cn/docs/#checks', href: '/zh-cn/docs/#checks' },
    { title: 'typo-suspect 检查', meta: '/zh-cn/docs/#check-typo', href: '/zh-cn/docs/#check-typo' },
    { title: 'direct-url 检查', meta: '/zh-cn/docs/#check-direct-url', href: '/zh-cn/docs/#check-direct-url' },
    { title: 'recent-release 检查', meta: '/zh-cn/docs/#check-recent-release', href: '/zh-cn/docs/#check-recent-release' },
    { title: 'empty-description 检查', meta: '/zh-cn/docs/#check-empty-description', href: '/zh-cn/docs/#check-empty-description' },
    { title: 'suspicious-url 检查', meta: '/zh-cn/docs/#check-suspicious-url', href: '/zh-cn/docs/#check-suspicious-url' },
    { title: 'repository-mismatch 检查', meta: '/zh-cn/docs/#check-repository-mismatch', href: '/zh-cn/docs/#check-repository-mismatch' },
    { title: 'email-domain-drift 检查', meta: '/zh-cn/docs/#check-email-domain-drift', href: '/zh-cn/docs/#check-email-domain-drift' },
    { title: 'zero-version 检查', meta: '/zh-cn/docs/#check-zero-version', href: '/zh-cn/docs/#check-zero-version' },
    { title: 'suspicious-pth 检查', meta: '/zh-cn/docs/#check-suspicious-pth', href: '/zh-cn/docs/#check-suspicious-pth' },
