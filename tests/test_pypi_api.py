...
class OfficialPyPIClientTests(unittest.TestCase):
    ...
    def test_fetch_all_project_names_parses_simple_index_response(self) -> None:
        ...
        with patch(
            "secpipw.pypi_api.urlopen", return_value=FakeHTTPResponse(payload)
        ) as mocked:
