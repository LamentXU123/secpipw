...
from secured_pip.install_plan import InstallPlan, ResolvedPackage
from secured_pip.pip_guard import (
...
def patch_guarded_install(
    ...
    cm = patch("secured_pip.pip_guard.InstallationReport")
...
class PipGuardTests(unittest.TestCase):
    ...
    def test_install_given_reqs_wrapper_omits_removed_global_options(self) -> None:
        ...
        with patch("secured_pip.pip_guard._pip_install_given_reqs", pip_install):
    ...
    def test_plan_hook_blocks_before_build_or_install(self) -> None:
        ...
        build_mock = patch("secured_pip.pip_guard.build")
    ...
    def test_json_report_file_writes_report_to_stdout_when_dash(self) -> None:
        ...
        report_patch = patch("secured_pip.pip_guard.InstallationReport")
        print_mock = patch("secured_pip.pip_guard.print_json")
        build_mock = patch("secured_pip.pip_guard.build")
        install_mock = patch("secured_pip.pip_guard.install_given_reqs")
